      ...
      <div>
        ...
        <label>
          ...
          <select
            ...
            onChange={e=>handleInputChange(e,setNewCompetidor,data.liga.EquipoInsignia)}
          >
        ...
        <button onClick={()=>agregarJugador(sendRequest,newCompetidor)}>Guardar competidor</button>
      </div>
      <div>
          <Listado data={data} setData={setData} openModal={openModal} sendRequest={sendRequest}/>
      </div>
